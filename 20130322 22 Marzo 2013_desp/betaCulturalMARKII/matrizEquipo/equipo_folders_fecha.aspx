<%@ Page Title="" Language="C#" MasterPageFile="~/mp_MenuPrincipal.Master" AutoEventWireup="true" CodeBehind="equipo_folders_fecha.aspx.cs" Inherits="betaCulturalMARKII.matrizEquipo.equipo_folders_fecha" %>
 ...
 <!--pnl_content_calendario--->
   ...
   <asp:Panel ID="pnl_content_folders" runat="server">
    ...
    <table>
     ...
     <asp:Table ID="tbl_verTodasMatrizEquipo" runat="server" CssClass="textoNormal_" >
            <asp:TableRow>
                <asp:TableCell>
                <asp:Label ID="lbl_aviso_indicacionesMatrizEquipo" CssClass="textoNormal_" runat="server"></asp:Label>
                            
                <asp:DataGrid ID="dg_verTodasMatrizesEquipo" runat="server" CssClass="resultTable"
                                        BorderStyle="Solid" BorderWidth="1px" ForeColor="Black" 
                                        BackColor="White" BorderColor="#999999" HeaderStyle-Font-Bold="true" 
                                        ShowHeader="true" GridLines="None" CellPadding="4"
                                         OnItemCommand="dg_verTodasMatrizesEquipo_ItemCommand"
                                        OnItemCreated="dg_verTodasMatrizesEquipo_OnItemCreated" DataKeyField="eficiencia"
                                        AutoGenerateColumns="false"  Width="800px" AlternatingItemStyle-BackColor="#A9EFFE">
                                ...
                                <Columns>
                                    ...
                                    <%--5--%><asp:BoundColumn   DataField="f_inicio"     HeaderText="Start Date">    </asp:BoundColumn>
                                    <%--6--%><asp:BoundColumn   DataField="f_final"      HeaderText="End Date">      </asp:BoundColumn>
                                    <%--3--%><asp:BoundColumn   DataField="eficiencia"   HeaderText="Effectiveness">   </asp:BoundColumn>
					                <%--4--%><asp:BoundColumn   DataField="eficacia"     HeaderText="Efficiency">     </asp:BoundColumn>
                                    <asp:TemplateColumn HeaderText="Overall" ItemStyle-Width="120px" HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                        <asp:Panel ID="pnl_bar_grafica_equipo" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="100px">
                                                <asp:Image  ID="lbl_grafica_mat_equipo" runat="server"> </asp:Image>
