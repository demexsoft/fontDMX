...
namespace betaCulturalMARKII.objetivoIndiv{
    public class cls_objetivo
    {
        ...
        public int modificarObjetivo(int IDMatriz, int IDobjetivo, string descripcionObj, string fechaCompromiso,
                                   int IDempleado, int IDequipo)
        {
            ...
            try
            {
                ...
                parametroMySql[6] = new SqlParameter("@Resp", SqlDbType.Int);
                ...
                parametroMySql[6].Direction = ParameterDirection.ReturnValue;


                accesoMysql.fn_getResultado_Command(parametroMySql, "modificarObjetivo");
                respuesta = int.Parse(parametroMySql[6].Value.ToString());
